using Catalyte.Theater.API.Filters;
using System.Net.Mime;
using Catalyte.Theater.Data;
using Catalyte.Theater.Data.Context;
using Catalyte.Theater.Providers;
...
namespace Catalyte.Theater.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "Catalyte.Theater.API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, TheaterCtx db)
        {
            if (env.IsDevelopment())
            {
                app.UseDeveloperExceptionPage();
                app.UseSwagger();
                app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "Catalyte.Theater.API v1"));
            }
