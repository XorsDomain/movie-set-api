...
using Catalyte.Theater.Data.Repositories;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using System;

namespace Catalyte.Theater.Data
{
    /// <summary>
    ...
    public static class ServicesConfiguration
    {
        public static IServiceCollection AddDataServices(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.AddDbContext<TheaterCtx>(options =>
            {
                if (config.GetValue<bool>("IsDevelopment"))
                {
                    options.UseNpgsql(config.GetConnectionString("CatalyteTheater"));
                }
                else
                {
            ...
            services.AddScoped<ITheaterCtx>(provider => provider.GetService<TheaterCtx>());
